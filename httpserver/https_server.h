...
private:
    ...
    std::string server_header_ = "Arqma Storage Server/" + std::string{STORAGE_SERVER_VERSION_STRING};
    ...
    friend void queue_resonse_internal(HTTPSServer& https, HttpResponse& r, Response res, bool force_close);
};
