...
namespace arqma::http {
    ...
    constexpr auto SNODE_SENDER_HEADER = "X-Arqma-Snode-PubKey";
    constexpr auto SNODE_TARGET_HEADER = "X-Arqma-Target-Snode-Key";
    constexpr auto SNODE_SIGNATURE_HEADER = "X-Arqma-Snode-Signature";
    constexpr auto SENDER_KEY_HEADER = "X-Arqma-Sender-Public-Key";
    constexpr auto SNODE_PUBKEY_HEADER = "X-Arqma-Snode-Pubkey";
