...
#define ARQMA_LOG_N(LVL, msg, ...) \
    spdlog::get("arqma_logger")->log(spdlog::source_loc{__FILE__, __LINE__, __PRETTY_FUNCTION__}, spdlog::level::LVL, msg, __VA_ARGS__)
#define ARQMA_LOG_2(LVL, msg) \
    spdlog::get("arqma_logger")->log(spdlog::source_loc{__FILE__, __LINE__, __PRETTY_FUNCTION__}, spdlog::level::LVL, msg)
